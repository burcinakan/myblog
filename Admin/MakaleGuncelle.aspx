<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master"  AutoEventWireup="true" CodeBehind="MakaleGuncelle.aspx.cs" Inherits="BurcinAkan_Blog.Admin.MakaleGuncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnl_basarili" runat="server" Visible="false">
        <div class="mesajbasarili">
            <b>Başarılı!</b> Makale Güncelleme başarılı
        </div>
    </asp:Panel>
    <asp:Panel ID="pnl_basarisiz" runat="server" Visible="false">
         <div class="mesajbasarisiz">
            <b>Başarısız!</b> Makale güncellenirken bir hata oluştu
        </div>
    </asp:Panel>
    <div class="form genis" style="min-height: 250px;">
        ...
        <div class="formIcerik">
            ...
            <div class="satir">
                ...
                <asp:Image ID="img_resim" runat="server" Height="300" />
            </div>
            <div class="satir">
                <label>Resim Değiştir:</label>
                <asp:FileUpload ID="fu_resim" runat="server" />
            </div>
            <div class="satir">
                <asp:LinkButton ID="lbtn_ekle" runat="server" Text="Makale Güncelle" CssClass="buton" OnClick="lbtn_ekle_Click"></asp:LinkButton>
            </div>
        </div>
    </div>
    <script>
